...
var mountainImages = [ 'recources/imgs/scene/mountains01.png', 'recources/imgs/scene/mountains02.png', 'recources/imgs/scene/mountains03.png', 'recources/imgs/scene/mountains04.png'];
var cloudImages = [ 'recources/imgs/scene/cloud01.png', 'recources/imgs/scene/cloud02.png'];
var brickImages = [ 'recources/imgs/blocks/blocks001.png', 'recources/imgs/blocks/blocks002.png', 'recources/imgs/blocks/blocks003.png'];
var coinsImags = [ 'recources/imgs/blocks/coin01.png', 'recources/imgs/blocks/coin05.png' ];
var pipeImages = [ 'recources/imgs/scene/tube.png' ];
var platformImages = [ 'recources/imgs/scene/platform.png' ];
var enemyMushroomImage = [ 'recources/imgs/enemy/enemyMushroom01.png','recources/imgs/enemy/enemyMushroom02.png'];
...
function loadPlatforms() {
  img=loadImage('recources/imgs/scene/platform.png');
  for(i=0;i<70;i++){
    randomNumber=random();
    if(randomNumber>0.2){
...
function MarioAnimation(){
  ...
  mario.addAnimation("stand",'recources/imgs/mario/mario06.png');
  mario.addAnimation("move",'recources/imgs/mario/mario01.png','recources/imgs/mario/mario03.png');
  mario.addAnimation("crouch",'recources/imgs/mario/mario18.png');
  mario.addAnimation("jump",'recources/imgs/mario/mario05.png');
  mario.addAnimation("dead",'recources/imgs/mario/mario24.png');
};
